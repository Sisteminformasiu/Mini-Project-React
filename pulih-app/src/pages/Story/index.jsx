    ...
    <div className="w-screen h-screen">
      {isDataLoaded && loading ? (
        <div className="w-screen h-screen flex flex-col justify-center items-center">
          <p className="font-semibold text-2xl">Tarik nafas yang dalam,</p>
          <div className="w-96 relative flex justify-center items-end font-semibold text-2xl">
            lalu hembuskan perlahan
            <p className="absolute right-7 bottom-1 custom-loader"></p>
          </div>
        </div>
      ) : (
        <div>
